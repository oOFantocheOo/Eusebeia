...
namespace ArduinoJson {
namespace Internals {
template <typename T> struct JsonVariantDefault {
  static T get() { return T(); }
};
template <typename T>
struct JsonVariantDefault<const T> : JsonVariantDefault<T> {};
template <typename T> struct JsonVariantDefault<T &> : JsonVariantDefault<T> {};
} // namespace Internals
} // namespace ArduinoJson
namespace ArduinoJson {
class JsonArray;
...
namespace ArduinoJson {
namespace Internals {
template <typename T> struct JsonVariantAs { typedef T type; };
template <> struct JsonVariantAs<char *> { typedef const char *type; };
template <> struct JsonVariantAs<JsonArray> { typedef JsonArray &type; };
template <> struct JsonVariantAs<const JsonArray> {
  typedef const JsonArray &type;
};
template <> struct JsonVariantAs<JsonObject> { typedef JsonObject &type; };
template <> struct JsonVariantAs<const JsonObject> {
...
namespace ArduinoJson {
namespace Internals {
template <typename TImpl> class JsonVariantCasts {
public:
...
namespace ArduinoJson {
namespace Internals {
template <typename TBase, typename TDerived> class IsBaseOf {
...
namespace ArduinoJson {
namespace Internals {
template <typename TString, typename Enable = void> struct StringTraits {
...
struct StringTraits<
    TStream, typename EnableIf<IsBaseOf<
...
namespace ArduinoJson {
namespace Internals {
template <typename TChar> struct CharPointerTraits {
  class Reader {
    const TChar *_ptr;
  ...
  public:
    ...
    void move() { ++_ptr; }
    char current() const { return char(_ptr[0]); }
    char next() const { return char(_ptr[1]); }
  };
  ...
  static bool is_null(const TChar *str) { return !str; }
...
namespace ArduinoJson {
namespace Internals {
template <> struct StringTraits<const __FlashStringHelper *, void> {
  class Reader {
    const char *_ptr;
  ...
  public:
    ...
    void move() { _ptr++; }
    char current() const { return pgm_read_byte_near(_ptr); }
    char next() const { return pgm_read_byte_near(_ptr + 1); }
  };
  ...
  static bool is_null(const __FlashStringHelper *str) { return !str; }
  typedef const char *duplicate_t;
  template <typename Buffer>
  static duplicate_t duplicate(const __FlashStringHelper *str, Buffer *buffer) {
    ...
    void *dup = buffer->alloc(size);
    if (dup != NULL)
      memcpy_P(dup, (const char *)str, size);
    return static_cast<duplicate_t>(dup);
  }
  static const bool has_append = false;
  static const bool has_equals = true;
...
namespace ArduinoJson {
namespace Internals {
template <typename TString> struct StdStringTraits {
  typedef const char *duplicate_t;
  template <typename Buffer>
  static duplicate_t duplicate(const TString &str, Buffer *buffer) {
    if (!str.c_str())
      return NULL; // <- Arduino string can return NULL
  ...
  static bool is_null(const TString &str) { return !str.c_str(); }
  ...
  static void append(TString &str, char c) { str += c; }
  static void append(TString &str, const char *s) { str += s; }
  static const bool has_append = true;
  static const bool has_equals = true;
  static const bool should_duplicate = true;
};
#if ARDUINOJSON_ENABLE_ARDUINO_STRING
template <> struct StringTraits<String, void> : StdStringTraits<String> {};
template <>
...
namespace ArduinoJson {
namespace Internals {
template <typename TImpl> class JsonVariantComparisons {
public:
...
private:
  const TImpl *impl() const { return static_cast<const TImpl *>(this); }
  template <typename T> const typename JsonVariantAs<T>::type as() const {
    return impl()->template as<T>();
  }
  template <typename T> bool is() const { return impl()->template is<T>(); }
  template <typename TString>
  typename EnableIf<StringTraits<TString>::has_equals, bool>::type
...
namespace ArduinoJson {
namespace Internals {
template <typename TImpl> class JsonVariantOr {
public:
  template <typename T>
  ...
  typename EnableIf<IsIntegral<Integer>::value, Integer>::type
  operator|(const Integer &defaultValue) const {
...
template <typename TImpl> class JsonVariantSubscripts {
public:
  size_t size() const {
...
namespace ArduinoJson {
namespace Internals {
template <typename TString> class DynamicStringBuilder {
public:
...
namespace ArduinoJson {
namespace Internals {
template <typename Print> class IndentedPrint {
public:
...
template <typename T> bool isInfinity(T x) { return x != 0.0 && x * 2 == x; }
} // namespace Internals
} // namespace ArduinoJson
...
template <typename T> struct FloatTraits<T, 8 /*64bits*/> {
  ...
  template <typename TExponent> static T make_float(T m, TExponent e) {
    if (e > 0) {
  ...
  static T positiveBinaryPowerOfTen(int index) {
    static T factors[] = {1e1,
                          1e2,
                          1e4,
                          1e8,
                          1e16,
                          1e32,
                          forge(0x4D384F03, 0xE93FF9F5),
                          forge(0x5A827748, 0xF9301D32),
                          forge(0x75154FDD, 0x7F73BF3C)};
    return factors[index];
  }
  static T negativeBinaryPowerOfTen(int index) {
    static T factors[] = {1e-1,
                          1e-2,
                          1e-4,
                          1e-8,
                          1e-16,
                          1e-32,
                          forge(0x32A50FFD, 0x44F4A73D),
                          forge(0x255BBA08, 0xCF8C979D),
                          forge(0x0AC80628, 0x64AC6F43)};
    return factors[index];
  }
  static T negativeBinaryPowerOfTenPlusOne(int index) {
    static T factors[] = {1e0,
                          1e-1,
                          1e-3,
                          1e-7,
                          1e-15,
                          1e-31,
                          forge(0x32DA53FC, 0x9631D10D),
                          forge(0x25915445, 0x81B7DEC2),
...
namespace ArduinoJson {
namespace Internals {
template <typename TFloat> struct FloatParts {
  uint32_t integral;
  uint32_t decimal;
  int16_t exponent;
...
namespace ArduinoJson {
namespace Internals {
template <typename Print> class JsonWriter {
public:
  ...
  template <typename TFloat> void writeFloat(TFloat value) {
    if (isNaN(value))
      return writeRaw("NaN");
    if (value < 0.0) {
      writeRaw('-');
  ...
  template <typename UInt> void writeInteger(UInt value) {
    char buffer[22];
...
class JsonArraySubscript;
template <typename TKey> class JsonObjectSubscript;
template <typename Writer> class JsonSerializer {
public:
...
namespace ArduinoJson {
namespace Internals {
template <typename Print> class Prettyfier {
public:
...
public:
  ...
  template <size_t N> size_t printTo(char (&buffer)[N]) const {
  ...
  template <size_t N> size_t prettyPrintTo(char (&buffer)[N]) const {
...
namespace ArduinoJson {
namespace Internals {
template <typename T> class RawJsonString {
public:
...
template <typename String> struct StringTraits<RawJsonString<String>, void> {
...
template <typename T> inline Internals::RawJsonString<T> RawJson(T str) {
...
class JsonVariant : public Internals::JsonVariantBase<JsonVariant> {
  template <typename Print> friend class Internals::JsonSerializer;
...
public:
  ...
  template <typename T>
  typename Internals::EnableIf<Internals::IsIntegral<T>::value, bool>::type
  is() const {
...
private:
  ...
  template <typename T> T variantAsFloat() const;
  ...
  bool variantIsArray() const { return _type == Internals::JSON_ARRAY; }
  bool variantIsObject() const { return _type == Internals::JSON_OBJECT; }
...
namespace ArduinoJson {
namespace Internals {
template <typename TChar> class StringWriter {
public:
  class String {
  public:
    String(TChar **ptr) : _writePtr(ptr), _startPtr(*ptr) {}
    void append(char c) { *(*_writePtr)++ = TChar(c); }
  ...
  String startString() { return String(&_ptr); }
...
namespace ArduinoJson {
namespace Internals {
template <typename TReader, typename TWriter> class JsonParser {
public:
  JsonParser(JsonBuffer *buffer, TReader reader, TWriter writer,
             uint8_t nestingLimit)
      : _buffer(buffer), _reader(reader), _writer(writer),
...
private:
  ...
  FORCE_INLINE bool eat(char charToSkip) { return eat(_reader, charToSkip); }
...
inline typename JsonParserBuilder<TJsonBuffer, TString>::TParser
makeParser(TJsonBuffer *buffer, TString &json, uint8_t nestingLimit) {
    ...
    void append(char c) {
      if (_parent->canAllocInHead(1)) {
        ...
        *end = c;
        ...
        if (_start && newStart)
          memcpy(newStart, _start, _length);
        if (newStart)
          newStart[_length] = c;
        _start = newStart;
      }
...
private:
  void alignNextAlloc() {
    if (_head)
      _head->size = this->round_size_up(_head->size);
  }
...
namespace ArduinoJson {
namespace Internals {
template <typename T> struct ListNode : public Internals::JsonBufferAllocated {
...
namespace ArduinoJson {
namespace Internals {
template <typename Source, typename Enable = void> struct ValueSaver {
...
public:
  ...
  template <typename T> bool add(T *value) { return add_impl<T *>(value); }
  template <typename T>
  DEPRECATED("Second argument is not supported anymore")
  ...
  FORCE_INLINE void removeAt(size_t index) { return remove(index); }
#endif
private:
...
class JsonBuffer;
namespace Internals {
template <typename> class JsonObjectSubscript;
}
...
public:
  ...
  template <typename TString>
  Internals::JsonObjectSubscript<const TString &>
  operator[](const TString &key) {
  ...
  template <typename TString>
  const Internals::JsonObjectSubscript<const TString &>
  operator[](const TString &key) const {
    return Internals::JsonObjectSubscript<const TString &>(
        *const_cast<JsonObject *>(this), key);
  }
  template <typename TString>
  const Internals::JsonObjectSubscript<TString *>
  ...
  template <typename TValue, typename TString> bool is(TString *key) const {
    return is_impl<TString *, TValue>(key);
  }
  template <typename TString> JsonArray &createNestedArray(const TString &key) {
    return createNestedArray_impl<const TString &>(key);
  }
  template <typename TString> JsonArray &createNestedArray(TString *key) {
  ...
  template <typename TString> JsonObject &createNestedObject(TString *key) {
    return createNestedObject_impl<TString *>(key);
  }
  template <typename TString> bool containsKey(const TString &key) const {
    return findKey<const TString &>(key) != end();
  }
  template <typename TString> bool containsKey(TString *key) const {
    return findKey<TString *>(key) != end();
  }
  template <typename TString> void remove(const TString &key) {
    remove(findKey<const TString &>(key));
  }
  template <typename TString> void remove(TString *key) {
...
private:
  template <typename TStringRef> iterator findKey(TStringRef key) {
    iterator it;
    for (it = begin(); it != end(); ++it) {
      if (Internals::StringTraits<TStringRef>::equals(key, it->key))
        break;
    }
    return it;
  }
  template <typename TStringRef> const_iterator findKey(TStringRef key) const {
    return const_cast<JsonObject *>(this)->findKey<TStringRef>(key);
  }
  template <typename TStringRef, typename TValue>
  typename Internals::JsonVariantAs<TValue>::type
  get_impl(TStringRef key) const {
  ...
  bool set_impl(TStringRef key, TValueRef value) {
    if (Internals::StringTraits<TStringRef>::is_null(key))
      return false;
...
namespace Internals {
template <> struct JsonVariantDefault<JsonObject> {
  static JsonObject &get() { return JsonObject::invalid(); }
};
} // namespace Internals
} // namespace ArduinoJson
namespace ArduinoJson {
...
namespace ArduinoJson {
namespace Internals {
template <typename TInput> void skipSpacesAndComments(TInput &input) {
  for (;;) {
...
inline bool
ArduinoJson::Internals::JsonParser<TReader, TWriter>::eat(TReader &reader,
                                                          char charToSkip) {
  skipSpacesAndComments(reader);
  if (reader.current() != charToSkip)
    return false;
  reader.move();
  return true;
}
...
public:
  ...
  template <typename T> FORCE_INLINE JsonArraySubscript &operator=(T *src) {
    _array.set(_index, src);
    return *this;
  }
  ...
  template <typename TValue> FORCE_INLINE bool set(const TValue &value) {
...
template <typename TImpl>
inline JsonArraySubscript JsonVariantSubscripts<TImpl>::
operator[](size_t index) {
  return impl()->template as<JsonArray>()[index];
}
template <typename TImpl>
inline const JsonArraySubscript JsonVariantSubscripts<TImpl>::
...
inline const Internals::JsonArraySubscript JsonArray::
operator[](size_t index) const {
...
public:
  ...
  template <typename TValue> FORCE_INLINE this_type &operator=(TValue *src) {
    _object.set(_key, src);
    return *this;
  }
  ...
  template <typename TValue> FORCE_INLINE bool is() const {
    return _object.is<TValue>(_key);
  }
  template <typename TValue>
  FORCE_INLINE typename EnableIf<!IsArray<TValue>::value, bool>::type
...
namespace ArduinoJson {
namespace Internals {
template <typename T> inline T parseFloat(const char *s) {
...
namespace ArduinoJson {
namespace Internals {
template <typename T> T parseInteger(const char *s) {
  if (!s)
    return 0; // NULL
  if (*s == 't')
    return 1; // "true"
...
inline JsonArray &JsonVariant::variantAsArray() const {
  if (_type == Internals::JSON_ARRAY)
    return *_content.asArray;
  return JsonArray::invalid();
}
inline JsonObject &JsonVariant::variantAsObject() const {
  if (_type == Internals::JSON_OBJECT)
    return *_content.asObject;
  return JsonObject::invalid();
}
template <typename T> inline T JsonVariant::variantAsInteger() const {
  using namespace Internals;
  switch (_type) {
  case JSON_UNDEFINED:
    return 0;
...
template <typename T> inline T JsonVariant::variantAsFloat() const {
  using namespace Internals;
  switch (_type) {
  case JSON_UNDEFINED:
    return 0;
...
inline bool JsonVariant::variantIsBoolean() const {
  ...
  if (_type == JSON_BOOLEAN)
    return true;
  if (_type != JSON_UNPARSED || _content.asString == NULL)
    return false;
